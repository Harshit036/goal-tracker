...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between rounded-lg border px-3 py-2 text-sm shadow-sm transition-all duration-200",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-[var(--fg)] hover:bg-[var(--surface-2)] focus:bg-[var(--surface-2)]",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-xs font-semibold text-[var(--fg-muted)] uppercase tracking-wider", className)}
    {...props}
  />
));
