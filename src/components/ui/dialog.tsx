  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "p-6 shadow-2xl dark:shadow-black/50 sm:rounded-2xl",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 rounded-lg p-1 opacity-60 hover:opacity-100 text-[var(--fg)] hover:bg-[var(--surface-2)] transition-all">
        <X className="h-4 w-4" />
